...
import { setTextFilter, sortByDate, sortByName, sortByPrice, setStartDate, setEndDate } from '../actions/filters';

class PriceListFilters extends React.Component {
    state = {
...
export default connect(mapStateToProps)(PriceListFilters);